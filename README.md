...
A full [writeup document](https://github.com/REALBRICKD/AiAPIComparison/blob/master/API_Testing_Writeup.docx) with more detail (including evaluaiton criteria) is included in this repository as well. \
